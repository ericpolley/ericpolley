  ...
  return (
    <div className='w-full text-center'>
      ...
      <div className='flex flex-col w-full  items-center bg-slate-200 lg:mr-6'>
        ...
        <iframe className="shadow-xl mb-4 lg:w-[440px] lg:h-[250px]" width="560" height="315" src="https://www.youtube.com/embed/videoseries?list=PLce5_YZyrUw7dNEL7F1T4kxAp0mMuattO" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      ...
      <div className='flex flex-col w-full items-center bg-slate-200'>
        <p className='text-2xl mb-4 lg:mt-4'>80 Second Tutorials</p>
        <iframe className="shadow-xl mb-4 lg:w-[440px] lg:h-[250px]" width="560" height="315" src="https://www.youtube.com/embed/videoseries?list=PLce5_YZyrUw7cHSt2HV5esEjQJKOG2GHG" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
