...
{/* CARD START */}
      <div className='flex flex-col w-full  items-center text-black bg-slate-400 lg:mr-6 rounded-xl border-4 border-slate-500 mt-4'>
        ...
        <iframe className="shadow-xl mb-4 w-[85vw] h-[280px] md:h-[350px] md:w-[82vw] lg:w-[35vw]  lg:h-[32vh] border-8 rounded-xl border-slate-500" width="560" height="235" src="https://www.youtube.com/embed/videoseries?list=PLce5_YZyrUw5UZ4t0586vz3p1RqTKTJPP" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
