...
{/* CARD START */}
      <div className='flex flex-col w-full  items-center bg-slate-200 lg:mr-6 rounded-xl border-4 border-slate-500 mt-4'>
      ...
      {/* CARD END */}
{/* CARD START */}
      <div className='flex flex-col w-full items-center bg-slate-200  rounded-xl border-4 border-slate-500  mt-4'>
