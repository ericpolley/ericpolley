...
export default function Videos() {
  return (
    <div className='w-full text-center'>
      ...
      <div className='flex flex-col w-full  items-center bg-slate-200 lg:mr-6 rounded-xl border-4 border-slate-300'>
        <p className='text-2xl mb-4 mt-4'>Vlog Videos</p>
        <iframe className="shadow-xl mb-4 w-[85vw] h-[280px] md:h-[350px] md:w-[82vw]  lg:w-[39vw] lg:h-[37vh] border-8 rounded-xl border-slate-400" width="560" height="235" src="https://www.youtube.com/embed/videoseries?list=PLce5_YZyrUw7dNEL7F1T4kxAp0mMuattO" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      ...
      <div className='flex flex-col w-full items-center bg-slate-200  rounded-xl border-4 border-slate-300  mt-4'>
        ...
        <iframe className="shadow-xl mb-4 w-[85vw] h-[280px] md:h-[350px] lg:w-[39vw] lg:h-[37vh] border-8 rounded-xl border-slate-400" width="560" height="235" src="https://www.youtube.com/embed/videoseries?list=PLce5_YZyrUw7cHSt2HV5esEjQJKOG2GHG" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
