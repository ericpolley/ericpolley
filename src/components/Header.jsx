...
export default function Header() {
  ...
  return (
   ...
   {/* NAV BAR */}
        <div className='w-[80vw] flex justify-between mb-4'>
...
{/* NAV BUTTON */}
  <div id="navButton" className='hidden'>
    ...
    <button onClick={hideNav} type="button" className=" inline-flex w-full justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-100" id="menu-button" aria-expanded="true" aria-haspopup="true">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
  <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
</svg>
    </button>
  ...
  <div id="myLinks" className="absolute right-0 z-10 mt-2 w-32 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabIndex="-1">
    ...
    <p><Link to="/" className=' mr-3'><span>Home</span></Link></p>
    <p> <Link to="/about" className=' mr-3'><span>About</span></Link></p>
    <p> <Link to="/blog" className=' mr-3'><span>Blog</span></Link></p>
    <p> <Link to="/contact" className=' mr-3'><span>Contact</span></Link></p>
    <p> <Link to="/portfolio" className=' mr-3'><span>Portfolio</span></Link></p>
    <p> <Link to="/video" className=' mr-3'><span>Videos</span></Link></p>
...
{/* NAV BAR sm and larger */}
            <p className='mt-4 hidden sm:block'>
                <Link to="/" className=' mr-3'><span>Home</span></Link>
                <Link to="/about" className=' mr-3'><span>About</span></Link>
                <Link to="/blog" className=' mr-3'><span>Blog</span></Link>
                <Link to="/contact" className=' mr-3'><span>Contact</span></Link>
                <Link to="/portfolio" className=' mr-3'><span>Portfolio</span></Link>
                <Link to="/video" className=' mr-3'><span>Videos</span></Link>
            </p>
            </div>
        </div>
        </div>
