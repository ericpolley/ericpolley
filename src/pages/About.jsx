...
<br /><br />
During this time, Eric also developed an interest in programming and decided to start learning more about it. He began by dabbling in C# and Python, using Unreal Engine, Unity, and RPG Maker to create games. The tutorials for creating games are very complex. He quickly became lost in these languages and was less than excited to continue learning more. Perhaps the problem was He starting at expert level, coding polished games, instead of taking the time to learn the basics. Thankfully he learned, eventually.
<br /><br />
In the middle of 2022, Eric decided to fully commit to learning programming and started with HTML and CSS. He quickly became skilled in these languages and moved on to learning JavaScript and React.js. Eric had a particular interest in CSS and CSS frameworks, and his current favorite is Tailwind.
<br /><br />
